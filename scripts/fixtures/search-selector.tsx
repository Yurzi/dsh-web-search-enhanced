...
createRoot(document.getElementById('picker')!).render(<SearchConnectionSelector {...({sessionId: "fixture-session" as SessionId, ...selectionInjection(new SelectionClient(remote as SearchConnectionRemote), "fixture-session"), useProjection: () => undefined, t: (key: string) => zh[key as LocaleKey] ?? key} as SearchConnectionSelectorProps)}/>)
