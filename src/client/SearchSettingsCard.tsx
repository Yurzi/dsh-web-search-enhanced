...
interface TextFieldProps { label: string; hint: string; value: string; error?: string | undefined; disabled: boolean; wide?: boolean | undefined; inputMode?: 'text' | 'numeric' | undefined; type?: 'text' | 'password' | undefined; onChange: (value: string) => void }
