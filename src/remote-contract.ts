...
const responseSchema = z.object({ selection: selectionSchema, freshness: z.enum(['auto', 'fresh', 'realtime']), connections: z.array(z.object({ id: z.string(), label: z.string(), kind: z.enum(['model', 'structured']), configured: z.boolean(), reason: z.string().optional(), credentialRef: z.string().optional() }).strict()) }).strict()
